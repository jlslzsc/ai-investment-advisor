...
- `/scan 半导体` - 聚焦扫描半导体方向
- `/scan 趋势` - 寻找近期趋势明显的标的
- `/scan 美股` - 扫描美股市场机会（仅技术面分析）

## 市场支持说明

| 市场 | 宏观分析 | 行业分析 | 技术分析 | 资金流向 | 板块排名 |
|------|----------|----------|----------|----------|----------|
| A股 | ✅ | ✅ | ✅ | ✅ | ✅ |
| 港股 | ✅ | ✅ | ✅ | ❌ | ❌ |
| 美股 | ❌ | ❌ | ✅ | ❌ | ❌ |
...
- 不支持宏观环境和行业分析（数据源限制）
- 不支持资金流向和板块排名（需要付费API）
- 数据来源：pandas-datareader (Yahoo Finance / Stooq)
- 建议：主要分析用户已持有的美股标的，推荐新标的需基于用户关注方向
...
**美股**：
- 主要分析用户已持有的美股标的与标普100（从Holdings.md获取）
- 基于用户关注方向（Watchlist.md）推荐对应的美股标的
- 重点关注技术面：趋势、RSI、MACD、支撑压力位
- 提醒用户使用专业美股工具补充宏观和行业分析
